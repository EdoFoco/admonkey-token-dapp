...
/// @author Jimmy Chu <-- You are legend!! Get in touch, reward waiting!
...
contract LotteryPotFactory is Ownable {
    ...
    // --- Event Declaration ---
    event LotteryPotFactoryEnabled(bool indexed enabled);
    ...
    /// @dev Only honor request from this contract owner, aka, the platform admin.
    function disableLotteryPot(address payable potAddr)
        public
        onlyOwner
